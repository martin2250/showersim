...
depth, nuclei, pions, electrons, photons, muons, neutrinos, remainin_energy, ionization = np.loadtxt('result.txt', unpack=True)
...
plt.plot(depth, ionization / 1e6, label='ionization (MeV/m)')
